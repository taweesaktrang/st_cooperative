  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">เพิ่มสินค้า</a></li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <form id="defaultForm" class="form-horizontal" method="post" action="<?php echo base_url();?>index.php/product/save_product">
              <div class="box-body">
                <div class="form-group">
                  <label for="prd_id" class="col-sm-2 control-label">รหัสสินค้า</label>
                  <div class="col-sm-4">
                    <input type="text" class="form-control" id="prd_id"  name="prd_id" placeholder="รหัสสินค้า" maxlength="10" required>
                  </div>
                  <label for="prd_barcode" class="col-sm-2 control-label">barcode</label>
                  <div class="col-sm-4">
                    <input type="text" class="form-control" id="prd_barcode"  name="prd_barcode" placeholder="รหัส barcode สินค้า" maxlength="15" required>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="prd_name"  name="prd_name" placeholder="ชื่อสินค้า" maxlength="50" required>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="prd_detail"  name="prd_detail" placeholder="รายละเอียดสินค้า" maxlength="100" required>
                  </div>
                </div>
                ...
                <label class="col-sm-2 control-label">หมวดหมู่สินค้า</label>
				 <div class="col-sm-4">
					...
					<?php foreach($result as $c){?>
							 <option  value="<?php echo $c->prd_cat_id?>"><?php echo $c->prd_cat_name?></option>
				<?php } ?>
                  ...
                  <div class="col-sm-4">
                    <input type="text" class="form-control" id="prd_unit"  name="prd_unit" placeholder="หน่วยนับสินค้า" maxlength="10" required>
                  </div>
              </div>
			 ...
			 <div class="form-group">
                <label class="col-sm-2 control-label">ราคาทุน</label>
				 <div class="col-sm-4">
                    <input type="text" class="form-control" id="prd_cost_price"  name="prd_cost_price" placeholder="ราคาทุนสินค้า" maxlength="5" required>
				 </div>
                <label class="col-sm-2 control-label">ราคาขายสินค้า</label>
				 <div class="col-sm-4">
                    <input type="text" class="form-control" id="prd_sale_price"  name="prd_sale_price" placeholder="ราคาขายสินค้า" maxlength="5" required>
				 </div>
              </div>
			 ...
			 <div class="form-group">
                  ...
                  <div class="radio">
                    <label>
                      <input type="radio" name="prd_status" id="optionsRadios1" value="1" checked>
                       สินค้ามีจำหน่าย 
                    </label>

                    <label>
                      <input type="radio" name="prd_status" id="optionsRadios2" value="0">
                      สินค้าหมด
                    </label>
                  </div>
				</div>
