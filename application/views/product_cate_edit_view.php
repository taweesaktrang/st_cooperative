  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">แก้ไขหมวดหมู่สินค้า</a></li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <form id="defaultForm" class="form-horizontal" method="post" action="<?php echo base_url();?>index.php/product_cate/save_edit_product_cate">
              <div class="box-body">
                <div class="form-group">
                  <label for="prd_cat_id" class="col-sm-2 control-label">รหัสหมวดหมู่</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="prd_cat_id"  name="prd_cat_id"  value="<?php echo $result[0]->prd_cat_id?>" readonly>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="prd_cat_name"  name="prd_cat_name" placeholder="ชื่อหมวดหมู่สินค้า" maxlength="50" value="<?php echo $result[0]->prd_cat_name?>" required>
                  </div>
                </div>
